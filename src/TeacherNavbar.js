      ...
      <Navbar.Collapse id="basic-navbar-nav">
        ...
        <div className="row right-header">
            <div className="header-end">
                <NotificationsNoneOutlinedIcon className="notification-icon" style={{color:"#ff8a00"}} />
            </div>
            <div className="header-end">
                <ShoppingCartOutlinedIcon className="cart-icon" style={{color:"#ff8a00"}}/>
            </div>
            <div className="header-end">
                <AccountCircleIcon className="profile-icon"style={{color:"#ff8a00"}}/>
            </div>
          </div>
        </Navbar.Collapse>
      </Navbar>  

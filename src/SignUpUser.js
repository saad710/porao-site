...
import teacher from "./images/undraw_teaching_f1cm 1.png";
import student from "./images/undraw_exams_g4ow 1.png";
    ...
    return (
        <div className="sign-up-user">
            ...
            <div className="row sign-up-card">
                ...
                <div className="col-md-3">
                <Link className="t-sign" style={{ color: 'inherit', textDecoration: 'inherit'}} to="teacherSignup">
